...
import com.abdulkadiraktar.javamaps.adapter.PlaceAdapter;
import com.abdulkadiraktar.javamaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private CompositeDisposable compositeDisposable = new CompositeDisposable(); //ondestroy clear şart
    PlaceDatabase db;
    PlaceDao placeDao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        compositeDisposable.add(placeDao.getAll().subscribeOn(Schedulers.io())
                ...
                .subscribe(MainActivity.this::listActivity));


    }

    private void listActivity(List<Place> placeList){
    ...
    @Override
    public boolean onOptionsItemSelected(@NonNull MenuItem item) { //menücen bir şey seçilirse
        if(item.getItemId() == R.id.add_place){
            Intent intent = new Intent(MainActivity.this,MapsActivity.class);
            intent.putExtra("info", "new"); //delete butonu etkisizleştirme
